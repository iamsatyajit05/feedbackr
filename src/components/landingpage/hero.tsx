    ...
    return (
        <main className="z-10 max-w-5xl m-auto flex flex-col items-center justify-center gap-10 lg:gap-12 px-8 pt-12 pb-24 lg:py-32 text-center text-slate-800">
            ...
            <div className="flex flex-col md:flex-row gap-2 relative">
                ...
                <div className="absolute -right-20  md:-top-16 text-sm flex flex-col gap-1 items-center animate-opacity">
                    <p className="text-base-content-secondary/80">Feedbackr <br/> in action</p>
                    <svg
                        className="shrink-0 w-12 fill-secondary-foreground opacity-70 rotate-45"
                        viewBox="0 0 138 138"
                        fill="none"
