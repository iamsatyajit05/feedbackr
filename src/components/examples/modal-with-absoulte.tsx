...
const Feedbackr: React.FC<FeedbackrProps> = ({ children, projectId, userId }) => {
    ...
    return (
        <>
            <button
                className='z-10 px-4 py-2 border rounded-md absolute bottom-4 right-4 bg-gray-100 hover:bg-gray-200 transition-all'
...
export default function ModalWithAbsoulte() {
    return (
        <Dialog>
            <DialogTrigger>
                <div className="rounded-xl bg-gray-50 border space-y-2 p-4">
                    <VideoPlayer video="/examples/modal-absoulte.mp4" thumbnail="/examples/modal-absoulte.png" />
                    <p>Modal with Absoulte Position Trigger</p>
                </div>
            </DialogTrigger>
            <DialogContent>
                <DialogHeader>
                    <DialogTitle>Modal with Absoulte Position Trigger</DialogTitle>
